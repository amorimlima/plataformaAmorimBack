...
/**
 * The Interface CategoriaProducaoAlunoDAO.
 */
public interface CategoriaProducaoAlunoDAO {
		 ...
		 * @param p the p
		 */
		public void criar(CategoriaProducaoAluno p);
		 ...
		 * @param p the p
		 */
		public void deletar(CategoriaProducaoAluno p);
